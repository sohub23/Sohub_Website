...
const menuItems: MenuItem[] = [
  {
    ...
    href: '#initiatives',
    submenu: [
      { title: '', description: 'Communication without barriers', href: '#initiatives', image: sohubConnectLogo },
      { title: '', description: 'Hygienic food access', href: '#initiatives', image: oMamaLogo },
      { title: '', description: 'Execution & accountability OS', href: '#initiatives', image: empLogo },
